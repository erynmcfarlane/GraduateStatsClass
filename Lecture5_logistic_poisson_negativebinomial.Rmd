...
### Question: The coefficient for x1 is XX (FILL ME IN!) This means that the expected log count for a one-unit increase in x1 is XX. This means that the count difference (biological scale) for a one unit increase in x1 is XX.
...
negative_binomial_model<-glm.nb(y ~ x1, family="ne", data=data_negbiom)
