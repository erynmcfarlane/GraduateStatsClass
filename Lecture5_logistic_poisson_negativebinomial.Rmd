...
### Question: What is your imagined response variable here? What are your imagined predictors?

```{r Poisson Regression}



x1 = runif(1000, min = 0, max = 1) ### this is where I change my predictor variables
x2=runif(1000, min = 0, max = 1)
x3=runif(1000, min = 0, max = 1)
head(x) # First six values of x

lambda = exp(0.5 + 0.5*x + 2.5*x^2) ### here I'm simulating three betas against my three predictor variables to make my lambda
